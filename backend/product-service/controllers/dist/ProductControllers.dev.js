...
var Seller = require("../../seller-service/models/SellerModels"); // Tạo mới một sản phẩm
...
exports.createProduct = function _callee(req, res) {
  ...
  }, null, null, [[0, 38], [7, 20, 24, 32], [25,, 27, 31]]);
};
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return regeneratorRuntime.awrap(Product.find().populate('categoryId').populate('sellerId').populate('userId'));
  ...
  return regeneratorRuntime.async(function _callee8$(_context8) {
    while (1) {
      switch (_context8.prev = _context8.next) {
        case 0:
          _context8.prev = 0;
          limit = parseInt(req.query.limit) || 10; // Số lượng sản phẩm muốn trả về
  ...
  return regeneratorRuntime.async(function _callee9$(_context9) {
    while (1) {
      switch (_context9.prev = _context9.next) {
        case 0:
          _context9.prev = 0;
          productId = req.params.productId; // Populate cả category, seller và user nếu cần

          _context9.next = 4;
          return regeneratorRuntime.awrap(Product.findById(productId).populate('categoryId', 'name') // Lấy tên category
...
exports.getProductsBySeller = function _callee10(req, res) {
    ...
    while (1) {
      switch (_context10.prev = _context10.next) {
        ...
        case 8:
          ...
          console.error('Lỗi khi lấy sản phẩm theo seller:', _context10.t0);
          res.status(500).json({
            message: 'Đã xảy ra lỗi server'
          });
